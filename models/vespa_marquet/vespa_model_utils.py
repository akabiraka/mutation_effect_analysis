...
def compute_predictions(protid, seq, mutations):
    ...
    predictions_dict = {make_one_based_mutation(mutation):vespa_preds for mutation, vespa_preds in predictions}
    return predictions_dict




def get_predictions(prot_acc_version, seq, mutations, variants_df, model_preds_out_dir, task):
    new_out_path = home_dir+f"{model_preds_out_dir}{prot_acc_version}.pkl"
    prev_out_path = home_dir+f"models/vespa_marquet/outputs/vespa/{task}/raw_predictions_prev/{prot_acc_version}.pkl"
    ...
    if os.path.exists(new_out_path):
        ...
        print(f"..................merging vespa preds for {prot_acc_version}......................")
        ...
        prev_predictions_dict = {make_one_based_mutation(mutation):vespa_preds for mutation, vespa_preds in prev_predictions}
        ...
        if len(remaining_mutations)>0:
            new_predictions_dict = compute_predictions(prot_acc_version, seq, remaining_mutations)
        ...
        print(f"..................computing vespa preds for {prot_acc_version}...................")
